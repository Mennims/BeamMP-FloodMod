...
-- COLLISION MANAGER MODIFICATION: Simplified context without BJIPerm and BJICam dependencies
local function getContext()
    ...
    return {
        ...
        -- COMMENTED OUT: BJIPerm dependency not needed for CollisionsManager
        -- group = BJIPerm.Groups[BJIContext.User.group],
        veh = veh,
        vehPosRot = veh and BJIVeh.getPositionRotation(veh) or nil,
        isOwner = isOwner,
        vehData = vehData,
        -- COMMENTED OUT: BJICam dependency not needed for CollisionsManager
