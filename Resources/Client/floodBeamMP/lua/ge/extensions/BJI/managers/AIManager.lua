-- COLLISION MANAGER MODIFICATION: Minimal AIManager for CollisionsManager functionality only
local M = {
    _name = "BJIAI",
    state = true,
...
-- COMMENTED OUT: All other AI functionality not needed for CollisionsManager
-- Uncomment sections below if you need additional AI functionality later
